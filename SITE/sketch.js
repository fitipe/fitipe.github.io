...
cliprand = Math.floor(fxrand()*100);
...
if (cliprand < 13){
  clips = 5;
  ss = Math.floor(fxrand()*895);
  } else if (cliprand < 48) {
  clips = 4;
  ss = Math.floor(fxrand()*695);
  } else {
  clips= 3;
  ss = Math.floor(fxrand()*525);
  }


if (clips == 3){

  invnumlist = ['1st','2nd','3rd'];
